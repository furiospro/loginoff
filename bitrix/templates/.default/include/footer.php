<div class="ft_footer">
	...
	array(
		...
		"USE_EXT" => "N",
		"COMPONENT_TEMPLATE" => "bottom_vertical"
	),
	false
);?>
		...
		<div class="ft_contacts">
			<h4><?=mb_ucfirst(getMessage('CONTACT_INFO'));?></h4>
			...
			<p class="vcard">
				...
				<strong><?=mb_ucfirst(getMessage('WORKING_TIME'));?>:</strong> <br/> <span class="workhours">ежедневно с 9-00 до 18-00</span><br/>
			</p>
			<ul class="ft_solcial">
			...
			<div class="ft_copyright">© 2000 - 2012 "<?=mb_ucfirst(getMessage('FURNITURE_STORE'));?>" </div>
